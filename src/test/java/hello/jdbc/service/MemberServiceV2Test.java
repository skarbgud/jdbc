...
class MemberServiceV2Test {
    ...
    private MemberRepositroyV2 memberRepositroy;
    private MemberServiceV2 memberService;

    @BeforeEach
    void before() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource(URL, USERNAME, PASSWORD);
        memberRepositroy = new MemberRepositroyV2(dataSource);
        memberService = new MemberServiceV2(dataSource, memberRepositroy);
    }
